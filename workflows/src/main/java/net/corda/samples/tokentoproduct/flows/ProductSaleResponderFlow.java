 ...
 */
@InitiatedBy(ProductSaleInitiatorFlow.class)
public class ProductSaleResponderFlow extends FlowLogic<SignedTransaction> {

    private final FlowSession counterpartySession;

    public ProductSaleResponderFlow(FlowSession counterpartySession) {
